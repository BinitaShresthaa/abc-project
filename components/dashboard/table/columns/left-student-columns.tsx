...
export const leftStudentColumns: TableColumn<Student>[] = [
  {
  ...
  },
  {
    ...
    render: () => (
      <span className="rounded-full bg-red-50 px-2.5 py-1 text-xs font-medium text-red-600 dark:bg-red-500/10 dark:text-red-400">
        Left
      </span>
    ),
    exportValue: () => "Left",
...
export const leftStudentFilters: TableFilter<Student>[] = [
